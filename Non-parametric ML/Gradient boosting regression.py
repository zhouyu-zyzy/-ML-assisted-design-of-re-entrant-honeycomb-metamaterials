...
train_set.to_csv('E:/001-stimulation and procedure/10-data/01-model data/2-AdaBoost/train_set.csv', index=False)
final_set.to_csv('E:/001-stimulation and procedure/10-data/01-model data/2-AdaBoost/final_set.csv', index=False)

base_regressor = DecisionTreeRegressor(random_state=42)
model = AdaBoostRegressor(estimator=base_regressor, random_state=42)
...
for fold, (train_index, val_index) in enumerate(cv.split(X_train), 1):
    ...
    fold_train_set.to_csv(f'E:/001-stimulation and procedure/10-data/01-model data/2-AdaBoost/fold_{fold}_train.csv', index=False)
    fold_val_set.to_csv(f'E:/001-stimulation and procedure/10-data/01-model data/2-AdaBoost/fold_{fold}_val.csv', index=False)
...
cv_results_df.to_csv('E:/001-stimulation and procedure/10-data/01-model data/2-AdaBoost/cv_results.csv', index=False)
...
test_data = pd.DataFrame({'Actual': y_final, 'Predicted': y_pred_final})

train_data.to_csv('E:/001-stimulation and procedure/10-data/01-model data/2-AdaBoost/train_data.csv', index=False)
test_data.to_csv('E:/001-stimulation and procedure/10-data/01-model data/2-AdaBoost/test_data.csv', index=False)
...
error_df.to_csv('E:/001-stimulation and procedure/10-data/01-model data/2-AdaBoost/PS/error.csv', index=False)
